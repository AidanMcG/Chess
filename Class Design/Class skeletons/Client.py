...
class Client():
    ...
    def chess(self):
        ...
        player1_surf, player1_rect = self.makeText("Player 1", BASIC_FONT_SIZE, TEXT_COLOUR, BGCOLOUR, 430, 690)
        player2_surf, player2_rect = self.makeText("Player 2", BASIC_FONT_SIZE, TEXT_COLOUR, BGCOLOUR, 430, 10)
        over_surf, over_rect = self.makeText("Player 1 wins!", LARGE_FONT_SIZE, TEXT_COLOUR, YOU_WIN, 180, 220)
        ...
        while counter > 58:
            ...
            timer_surf, timer_rect = self.makeText("00:" + str(counter), SMALL_FONT_SIZE, BLACK, BANNER, (WINDOW_WIDTH)-135, (WINDOW_HEIGHT)-280) #timer surface has to be reinitialized every loop to put new loop in
